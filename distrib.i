...
%worlds () (MULN-right-distributes-over-ADDN* ADD(X1,X2)=X3 MUL(X3,X4)=X7 MUL(X1,X4)=X5 MUL(X2,X4)=X6
                                      %{=>}% ADD(X5,X6)=X7).
...
%worlds () (MULN-left-distributes-over-ADDN* ADD(X2,X4)=X6 MUL(X1,X6)=X7 MUL(X1,X2)=X3 MUL(X1,X4)=X5
                                    %{=>}% ADD(X3,X5)=X7).
...
%worlds () (MULN-left-distributes-over-ADDN ADD(X2,X4)=X6 MUL(X1,X6)=X7 
                                   %{=>}% X3 X5 MUL(X1,X2)=X3 MUL(X1,X4)=X5 ADD(X3,X5)=X7).
...
%worlds () (MULN-right-factors-over-ADDN MUL(X1,X4)=X5 MUL(X2,X4)=X6 ADD(X5,X6)=X7
...
%worlds () (MULN-right-factors-over-ADDN* MUL(X1,X4)=X5 MUL(X2,X4)=X6 ADD(X5,X6)=X7 ADD(X1,X2)=X3
                                 %{=>}% MUL(X3,X4)=X7 ).
...
%worlds () (MULN-left-factors-over-ADDN MUL(X1,X2)=X3 MUL(X1,X4)=X5 ADD(X3,X5)=X7
...
%worlds () (MULN-left-factors-over-ADDN* MUL(X1,X2)=X3 MUL(X1,X4)=X5 ADD(X3,X5)=X7 ADD(X2,X4)=X6 
                               %{=>}% MUL(X1,X6)=X7).
